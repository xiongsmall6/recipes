package com.xiong.recipes.imageload.app;
...
import com.xiong.recipes.imageload.image.CustomRequestListener;
import com.xiong.recipes.imageload.image.Utils;
...
public class ImageLoaderManager {
    ...
    public void displayImage(ImageView imageView, String url) {
        Glide.with(imageView.getContext())
                .asBitmap()
                .load(url)
                .apply(initCommonRequestOption().override(imageView.getWidth(), imageView.getWidth()))
                .transition(withCrossFade())
                .into(imageView);
    }
    ...
    public void displayImageForCircle(final ImageView imageView, String url ,Drawable placeHolder) {
        Glide.with(imageView.getContext())
                .asBitmap()
                .load(url)
                .apply(initCommonRequestOption(placeHolder))
                .into(new BitmapImageViewTarget(imageView) {
                    @Override
                    protected void setResource(final Bitmap resource) {
                        RoundedBitmapDrawable circularBitmapDrawable =
    ...
    private RequestOptions initCommonRequestOption() {
        ...
        options.placeholder(R.drawable.default_food)
    ...
    private RequestOptions initCommonRequestOption(Drawable placeHolder) {
        RequestOptions options = new RequestOptions();
